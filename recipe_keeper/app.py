...
app.config['MAIL_USERNAME'] = 'amicoserver@gmail.com'
app.config['MAIL_PASSWORD'] = 'zyuq kqqf qkqc hygj'  # Use App Password here
...
def add_family_member(family_id):
    ...
    try:
        # Convert to UUID string safely
        try:
            family_uuid = str(uuid.UUID(family_id))
        except ValueError:
...
{current_user.first_name} has invited you to view their recipes on Recipe Keeper.

Click the link below to accept the invitation:
http://localhost:3000/invite/{invitation_token}
